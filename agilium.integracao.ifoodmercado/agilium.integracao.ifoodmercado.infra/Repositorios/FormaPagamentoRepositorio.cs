...
{
    public class FormaPagamentoRepositorio: EFRepositorio<FormaPagamento>, IFormaPagamentoRepositorio
    {
        public FormaPagamentoRepositorio(dbContextAgilium context) : base(context)
        {
