...
{
    public class InventarioItemRepositorio: EFRepositorio<InventarioItem>, IInventarioItemRepositorio
    {
        public InventarioItemRepositorio(dbContextAgilium context) : base(context)
        {
