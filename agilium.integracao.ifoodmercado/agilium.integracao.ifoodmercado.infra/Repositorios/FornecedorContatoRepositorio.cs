...
{
    public class FornecedorContatoRepositorio: EFRepositorio<FornecedorContato>, IFornecedoreContatoRepositorio
    {
        public FornecedorContatoRepositorio(dbContextAgilium context) : base(context)
        {
