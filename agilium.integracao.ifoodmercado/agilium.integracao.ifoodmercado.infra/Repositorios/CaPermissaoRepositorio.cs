...
{
    public class CaPermissaoRepositorio: EFRepositorio<CaPermissao>, ICaPermissaoRepositorio
    {
        public CaPermissaoRepositorio(dbContextAgilium context) : base(context)
        {
