...
{
    public class ProdutoFotoRepositorio: EFRepositorio<ProdutoFoto>, IProdutoFotoRepositorio
    {
        public ProdutoFotoRepositorio(dbContextAgilium context) : base(context)
        {
