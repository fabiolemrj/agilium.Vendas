...
{
    public class ContaReceberRepositorio: EFRepositorio<ContaReceber>, IContasReceberRepositorio
    {
        public ContaReceberRepositorio(dbContextAgilium context) : base(context)
        {
