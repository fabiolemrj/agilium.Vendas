...
{
    public class PedidoVendaRepositorio: EFRepositorio<PedidoVenda>, IPedidoVendaRepositorio
    {
        public PedidoVendaRepositorio(dbContextAgilium context) : base(context)
        {
