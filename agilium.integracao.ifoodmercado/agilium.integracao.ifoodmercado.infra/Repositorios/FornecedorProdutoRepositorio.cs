...
{
    public class FornecedorProdutoRepositorio: EFRepositorio<FornecedorProduto>, IFornecedorProdutoRepositorio
    {
        public FornecedorProdutoRepositorio(dbContextAgilium context) : base(context)
        {
