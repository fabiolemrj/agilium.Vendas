...
{
    public class ClientePrecoRepositorio : EFRepositorio<ClientePreco>, IClientePrecoRepositorio
    {
        public ClientePrecoRepositorio(dbContextAgilium context) : base(context)
        {
