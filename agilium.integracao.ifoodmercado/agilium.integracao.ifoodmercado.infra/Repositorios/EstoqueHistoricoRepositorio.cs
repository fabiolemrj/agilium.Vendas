...
{
    public class EstoqueHistoricoRepositorio: EFRepositorio<EstoqueHistorico>, IEstoqueHistoricoRepositorio
    {
        public EstoqueHistoricoRepositorio(dbContextAgilium context) : base(context)
        {
