...
{
    public class VendaTemporariaRepositorio: EFRepositorio<VendaTemporaria>, IVendaTemporariaRepositorio
    {
        public VendaTemporariaRepositorio(dbContextAgilium context) : base(context)
        {
