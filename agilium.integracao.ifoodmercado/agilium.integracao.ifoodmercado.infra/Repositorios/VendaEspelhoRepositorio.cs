...
{
    public class VendaEspelhoRepositorio: EFRepositorio<VendaEspelho>, IVendaEspelhoRepositorio
    {
        public VendaEspelhoRepositorio(dbContextAgilium context) : base(context)
        {
