...
{
    public class GrupoProdutoRepositorio: EFRepositorio<GrupoProduto>, IGrupoProdutoRepositorio
    {
        public GrupoProdutoRepositorio(dbContextAgilium context) : base(context)
        {
