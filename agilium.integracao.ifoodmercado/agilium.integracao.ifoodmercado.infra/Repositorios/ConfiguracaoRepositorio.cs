...
{
    public class ConfiguracaoRepositorio: EFRepositorio<Configuracao>, IConfiguracaoRepositorio
    {
        public ConfiguracaoRepositorio(dbContextAgilium context) : base(context)
        {
