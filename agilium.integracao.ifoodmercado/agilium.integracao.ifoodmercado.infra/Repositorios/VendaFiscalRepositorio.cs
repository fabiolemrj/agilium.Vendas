...
{
    public class VendaFiscalRepositorio: EFRepositorio<VendaFiscal>, IVendaFiscaRepositorio
    {
        public VendaFiscalRepositorio(dbContextAgilium context) : base(context)
        {
