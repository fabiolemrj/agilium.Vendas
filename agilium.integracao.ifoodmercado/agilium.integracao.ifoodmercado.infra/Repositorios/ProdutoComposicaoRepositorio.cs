...
{
    public class ProdutoComposicaoRepositorio: EFRepositorio<ProdutoComposicao>, IProdutoComposicaoRepositorio
    {
        public ProdutoComposicaoRepositorio(dbContextAgilium context) : base(context)
        {
