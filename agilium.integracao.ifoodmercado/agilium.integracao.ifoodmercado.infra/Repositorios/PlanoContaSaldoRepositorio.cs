...
{
    public class PlanoContaSaldoRepositorio: EFRepositorio<PlanoContaSaldo>, IPlanoContaSaldoRepositorio
    {
        public PlanoContaSaldoRepositorio(dbContextAgilium context) : base(context)
        {
