...
{
    public class ConfiguracaoImagemRepositorio: EFRepositorio<ConfiguracaoImagem>, IConfiguracaoImagemRepositorio
    {
        public ConfiguracaoImagemRepositorio(dbContextAgilium context) : base(context)
        {
