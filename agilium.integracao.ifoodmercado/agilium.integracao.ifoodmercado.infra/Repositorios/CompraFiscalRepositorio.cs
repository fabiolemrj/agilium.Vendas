...
{
    public class CompraFiscalRepositorio: EFRepositorio<CompraFiscal>, ICompraFiscalRepositorio
    {
        public CompraFiscalRepositorio(dbContextAgilium context) : base(context)
        {
