...
{
    public class FuncionarioRepositorio: EFRepositorio<Funcionario>, IFuncionarioRepositorio
    {
        public FuncionarioRepositorio(dbContextAgilium context) : base(context)
        {
