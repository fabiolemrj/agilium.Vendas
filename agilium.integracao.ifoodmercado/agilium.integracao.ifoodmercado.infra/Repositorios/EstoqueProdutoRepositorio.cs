...
{
    public class EstoqueProdutoRepositorio: EFRepositorio<EstoqueProduto>, IEstoqueProdutoRepositorio
    {
        public EstoqueProdutoRepositorio(dbContextAgilium context) : base(context)
        {
