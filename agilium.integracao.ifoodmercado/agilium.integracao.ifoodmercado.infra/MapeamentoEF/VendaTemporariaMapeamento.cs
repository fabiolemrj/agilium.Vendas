...
{
    public class VendaTemporariaMapeamento : IEntityTypeConfiguration<VendaTemporaria>
    {
        public void Configure(EntityTypeBuilder<VendaTemporaria> builder)
        {
            ...
            builder
               .HasMany(vendatemp => vendatemp.VendaEspelho)
            ...
            builder
                .HasMany(vendatemp => vendatemp.VendaItem)
            ...
            builder
                .HasMany(vendaMoeda => vendaMoeda.VendaMoeda)
